...
@section('content')
    <div class="container-fluid">
        ...
        <ol class="breadcrumb mb-4 rounded-0">
            ...
            <li class="breadcrumb-item"><a href="{{route('user.team.all')}}">All Member</a></li>
                            ...
                            <div class="row">
                            	...
                            	<div class="col-md-4">
                            		<div class="form-group">
		                                ...
		                                <input type="text" name="name" class="form-control" id="full_name" autocomplete="off" required>
		                            </div>
                            	</div>
                            	<div class="col-md-4">
                            		<div class="form-group">
		                                <label for="name">Mobile <span class="text-danger">*</span> </label>
		                                <input type="text" name="mobile" class="form-control" id="mobile" autocomplete="off" required>
		                            </div>
                            	</div>
                            	<div class="col-md-4">
                            		<div class="form-group">
                            	...
                            	<div class="col-md-4">
                            		<div class="form-group">
		                                ...
		                                <input type="text" name="division" class="form-control" id="division" autocomplete="off" required>
		                            </div>
                            	</div>
                            	<div class="col-md-4">
                            		<div class="form-group">
                            	...
                            	<div class="col-md-4">
                            		<div class="form-group">
		                                <label for="name">Re-Password <span class="text-danger">*</span> </label>
