...
@section('content')
    <div class="container-fluid">
        ...
        <ol class="breadcrumb mb-4 rounded-0">
            ...
            <li class="breadcrumb-item active">Member Tree</li>
        </ol>
...
<div class="organogram">
    <ul>
        <li>
            <a href="{{ route('admin.user.profile', $user->user_id) }}" title="Go To Her Profile">{{ $user->name }}</a>
            @if(isset($tree->gn1))
            <ul>
                {{-- First Client --}}
                @foreach($tree->gn1 as $key=>$gn1c)
                    ...
                    <li>
                        <a href="{{ route('admin.user.profile', $gn1c->user_id) }}" title="G1 | Go To Her Profile">{{ $gn1c->name }}</a>
                        @if(isset($gn1c->gn2))
                            <ul>
                                {{-- Second Client --}}
                                ...
                                <li>
                                    <a href="{{ route('admin.user.profile', $gn2c->user_id) }}" title="G2 | Go To Her Profile">{{ $gn2c->name }}</a>
                                    @if(isset($gn2c->gn3))
                                        <ul>
                                            {{-- Therd Client --}}
                                            ...
                                            <li>
                                                <a href="{{ route('admin.user.profile', $gn3c->user_id) }}" title="G3 | Go To Her Profile">{{ $gn3c->name }}</a>
                                                @if(isset($gn3c->gn4))
                                                    <ul>
                                                        {{-- Fourth Client --}}
                                                        ...
                                                        <li>
                                                            <a href="{{ route('admin.user.profile', $gn4c->user_id) }}" title="G4 | Go To Her Profile">{{ $gn4c->name }}</a>
                                                            @if(isset($gn4c->gn5))
                                                                <ul>
                                                                    {{-- Fifth Client --}}
                                                                    ...
                                                                    <li>
                                                                        <a href="{{ route('admin.user.profile', $gn5c->user_id) }}" title="G5 | Go To Her Profile">{{ $gn5c->name }}</a>
                                                                        @if(isset($gn5c->gn6))
                                                                            <ul>
                                                                                {{-- Sixth client --}}
                                                                                ...
                                                                                <li>
                                                                                    <a href="{{ route('admin.user.profile', $gn6c->user_id) }}" title="G6 | Go To Her Profile">{{ $gn6c->name }}</a>
                                                                                    @if(isset($gn6c->gn7))
                                                                                        <ul>
                                                                                            {{-- Seventh Client --}}
                                                                                            ...
                                                                                            <li>
                                                                                                <a href="{{ route('admin.user.profile', $gn7c->user_id) }}" title="G7 | Go To Her Profile">{{ $gn7c->name }}</a>                        
                                                                                                @if(isset($gn7c->gn8))
                                                                                                    <ul>
                                                                                                        {{-- Eighth Client --}}
                                                                                                        ...
                                                                                                        <li>
                                                                                                            <a href="{{ route('admin.user.profile', $gn8c->user_id) }}" title="G8 | Go To Her Profile">{{ $gn8c->name }}</a>
                                                                                                            @if(isset($gn8c->gn9))
                                                                                                                <ul>
                                                                                                                    {{-- Ninth Client --}}
                                                                                                                    ...
                                                                                                                    <li>
                                                                                                                        <a href="{{ route('admin.user.profile', $gn9c->user_id) }}" title="G9 | Go To Her Profile">{{ $gn9c->name }}</a>
                                                                                                                        @if(isset($gn9c->gn10))
                                                                                                                        {{-- Tenth Client --}}
                                                                                                                            <ul>
                                                                                                                            @foreach($gn9c->gn10 as $gn10c)
                                                                                                                            @php($gn10c=(object)$gn10c)
                                                                                                                                <li><a href="{{ route('admin.user.profile', $gn10c->user_id) }}" title="G10 | Go To Her Profile">{{ $gn10c->name }}</a></li>
                                                                                                                            @endforeach
                                                                                                                            </ul>
                                                                                                                        @endif
                                                                                                                    </li>
