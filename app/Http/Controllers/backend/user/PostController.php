...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.user.post.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('backend.user.post.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('user.post')->with('success', 'Post successfully created.');
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.user.post.show', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.user.post.edit', $data);
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('user.post')->with('update', 'Post successfully updated.');
    }
